...
## Пример фронтенда
В каталоге `frontend/CarouselApp.jsx` лежит пример React-компонента для генерации и редактирования карусели постов (использует lucide-react и tailwind-стили). Он не завязан на бэкенд, но может служить стартовой точкой для UI.
